...
public class Update {
  ...
  private static final String TEMPLATE_CREATE = "UPDATE %table SET( %fields ) = (%values)";
  private static final String TEMPLATE_RETURNING = "RETURNING *";
  private static final String APOSTROPHE = "'";
  private static final String NULL = "NULL";

  private final String tableName;
  private final Map<String, Object> fieldValues;
  private final BuilderUpdatingTable query;


  private Where where;


  public Update fieldValues(Map<String, String> fieldValues) {
  ...
  public Update where(Map<String, String> where) {
    this.where = new Where(where);
    return this;
  }


  public BuilderUpdatingTable query() {
    return query;
  }
  ...
  public String toString() {
    ...
    var values = fieldValues.values().stream()
        .map(el -> Optional.ofNullable(el).map(el1 ->
                APOSTROPHE.concat(el.toString())
                    .concat(APOSTROPHE)
            ).orElse(NULL)
        )
