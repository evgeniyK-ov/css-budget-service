...
import static ru.sbrf.ufs.ssp.dictionary.core.constant.Constants.TEMPLATE_DICTIONARY_CODE_FOR_REPLACING;
import static ru.sbrf.ufs.ssp.dictionary.core.constant.Constants.TEMPLATE_PHYSICAL_TABLE_NAME;
...
import static ru.sbrf.ufs.ssp.dictionary.core.constant.Constants.TEMPLATE_TABLE_KEY_TYPE_FOR_REPLACING;
import static ru.sbrf.ufs.ssp.dictionary.core.constant.Constants.TEMPLATE_VERSION_NUMBER_FOR_REPLACING;

import java.util.List;
import java.util.stream.Collectors;
import lombok.AccessLevel;
import lombok.NoArgsConstructor;
import ru.sbrf.ufs.ssp.dictionary.core.model.KeyType;
